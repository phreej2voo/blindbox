	...
	<view class="uni-date">
        ...
        >
					<view v-if="!isRange" class="uni-date-x uni-date-single">
						<uni-icons class="icon-calendar" type="calendar" :color="displayValue? '#FFF' : 'rgba(255,255,255,0.42)'" size="22"></uni-icons>
						<view class="uni-date__x-input" :style="{'color': displayValue? '#FFF' : 'rgba(255,255,255,0.42)'}">{{ displayValue || singlePlaceholderText }}</view>
					</view>
            ...
            <view class="uni-date__x-input text-center">{{ displayRangeValue.endDate || endPlaceholderText }}</view>
					...
					<view v-if="showClearIcon" class="uni-date__icon-clear" @click.stop="clear">
						<uni-icons type="clear" :color="displayValue? '#FFF' : 'rgba(255,255,255,0.42)'" size="22"></uni-icons>
					</view>
				</view>
			</slot>
		</view>
